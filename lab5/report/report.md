...
![Добавление 10% потерь пакетов на хосте h1](images/5.png){ #fig:005 width=100% height=100% }
...
![Добавление 10% потерь пакетов на хосте h2](images/7.png){ #fig:007 width=100% height=100% }
...
![Восстановление конфигурации по умолчанию для хоста h1 и хоста h2](images/9.png){ #fig:009 width=100% height=100% }
...
![Добавление на узле h1 коэффициента потери пакетов 50%](images/11.png){ #fig:011 width=100% height=100% }
...
![Проверка](images/12.png){ #fig:012 width=100% height=100% }

Восстановим конфигурацию интерфейса по умолчанию на узле h1 (рис. [-@fig:013]):

![Восстановление конфигурации интерфейса по умолчанию](images/13.png){ #fig:013 width=100% height=100% }

Добавим на интерфейсе узла h1 0,01% повреждения пакетов (рис. [-@fig:014]):

![Добавление на узле h1 0.01% повреждения пакетов](images/14.png){ #fig:014 width=100% height=100% }
...
![Проверка конфигурации с помощью инструмента iPerf3 для проверки повторных передач](images/15.png){ #fig:015 width=100% height=100% }
...
![Добавление на узле h1 правила из лабораторной работы](images/17.png){ #fig:017 width=100% height=100% }
...
![Добавление на узле h1 правила с дублированием 50% пакетов](images/20.png){ #fig:020 width=100% height=100% }
...
![Проверка](images/21.png){ #fig:021 width=100% height=100% }

Восстановим конфигурацию интерфейса по умолчанию на узле h1 (рис. [-@fig:022]):

![Восстановление конфигурации интерфейса по умолчанию](images/22.png){ #fig:022 width=100% height=100% }
...
![Создание каталога expname](images/23.png){ #fig:023 width=100% height=100% }
...
![Создание каталога simple-drop и дальнейшее его открытие](images/24.png){ #fig:024 width=100% height=100% }

Создадим скрипт для эксперимента lab_netem_ii.py (рис. [-@fig:025]):

![Создание скрипта для эксперимента](images/25.png){ #fig:025 width=100% height=100% }

Затем создадим скрипт, чтобы на экран или в отдельный файл выводилась информация о потерях пакетов (рис. [-@fig:026]):

![Создание нового скрипта для вывода информации о потере пакетов](images/26.png){ #fig:026 width=100% height=100% }

Создадим Makefile для управления процессом проведения эксперимента (рис. [-@fig:027]):

![Создание Makefile и помещение в него скрипта](images/27.png){ #fig:027 width=100% height=100% }

Выполним эксперимент и далее очистим каталог от результатов проведения экспериментов (рис. [-@fig:028]):

![Выполнение эксперимента и последующая очистка каталога](images/28.png){ #fig:028 width=100% height=100% }
...
![Реализация воспроизводимого эксперимента по исследованию параметров сети](images/29.png){ #fig:029 width=100% height=100% }

![Реализация воспроизводимого эксперимента по исследованию параметров сети](images/30.png){ #fig:030 width=100% height=100% }

![Реализация воспроизводимого эксперимента по исследованию параметров сети](images/31.png){ #fig:031 width=100% height=100% }

![Реализация воспроизводимого эксперимента по исследованию параметров сети](images/32.png){ #fig:032 width=100% height=100% }
