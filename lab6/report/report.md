...
![Создание топологии с двумя хостами и двумя коммутаторами](images/2.png){ #fig:002 width=100% height=100% }
...
![Отображение информации сетевых интерфейсов и IP-адресов](images/3.png){ #fig:003 width=100% height=100% }
...
![Запуск iPerf3 в режиме сервера на хосте h2](images/5.png){ #fig:005 width=100% height=100% }

В терминале хоста h1 запустим iPerf3 в режиме клиента (рис. [-@fig:006]):

![Запуск iPerf3 в режиме клиента на хосте h1](images/6.png){ #fig:006 width=100% height=100% }

После завершения работы iPerf3 на хосте h1 остановим iPerf3 на хосте h2, нажав Ctrl + c (рис. [-@fig:007]):

![Остановка iPerf3](images/7.png){ #fig:007 width=100% height=100% }
...
![Изменение пропускной способности хоста h1](images/8.png){ #fig:008 width=100% height=100% }
...
![Установка значения всплеска при ограничении скорости для фильтра tbf](images/9.png){ #fig:009 width=100% height=100% }
...
![Запуск iPerf3 в режиме сервера на хосте h2](images/10.png){ #fig:010 width=100% height=100% }

В терминале хоста h1 запустим iPerf3 в режиме клиента (рис. [-@fig:011]):

![Запуск iPerf3 в режиме клиента на хосте h1](images/11.png){ #fig:011 width=100% height=100% }

После завершения работы iPerf3 на хосте h1 остановим iPerf3 на хосте h2, нажав Ctrl + c (рис. [-@fig:012]):

![Остановка iPerf3](images/12.png){ #fig:012 width=100% height=100% }

Удалим модифицированную конфигурацию на хосте h1 (рис. [-@fig:013]):

![Удаление модифицированной конфигурации на хосте h1](images/13.png){ #fig:013 width=100% height=100% }
...
![Применение правила ограничения скорости tbf](images/14.png){ #fig:014 width=100% height=100% }
...
![Запуск iPerf3 в режиме сервера на хосте h2](images/15.png){ #fig:015 width=100% height=100% }

В терминале хоста h1 запустим iPerf3 в режиме клиента (рис. [-@fig:016]):

![Запуск iPerf3 в режиме клиента на хосте h1](images/16.png){ #fig:016 width=100% height=100% }

После завершения работы iPerf3 на хосте h1 остановим iPerf3 на хосте h2, нажав Ctrl + c (рис. [-@fig:017]):

![Остановка iPerf3](images/17.png){ #fig:017 width=100% height=100% }

Удалим модифицированную конфигурацию на коммутаторе s1 (рис. [-@fig:018]):

![Удаление модифицированной конфигурации на коммутаторе s1](images/18.png){ #fig:018 width=100% height=100% }
...
![Объединение NETEM и TBF](images/19.png){ #fig:019 width=100% height=100% }
...
![Проверка задержки](images/20.png){ #fig:020 width=100% height=100% }
...
![Добавление второго правила на коммутаторе s1](images/21.png){ #fig:021 width=100% height=100% }

Проверим конфигурацию с помощью инструмента iperf3 для измерения пропускной способности.

В терминале хоста h2 запустим iPerf3 в режиме сервера (рис. [-@fig:022]):

![Запуск iPerf3 в режиме сервера на хосте h2](images/22.png){ #fig:022 width=100% height=100% }

В терминале хоста h1 запустим iPerf3 в режиме клиента (рис. [-@fig:023]):

![Запуск iPerf3 в режиме клиента на хосте h1](images/23.png){ #fig:023 width=100% height=100% }

После завершения работы iPerf3 на хосте h1 остановим iPerf3 на хосте h2, нажав Ctrl + c (рис. [-@fig:024]):

![Остановка iPerf3](images/24.png){ #fig:024 width=100% height=100% }

Удалим модифицированную конфигурацию на коммутаторе s1 (рис. [-@fig:025]):

![Удаление модифицированной конфигурации на коммутаторе s1](images/25.png){ #fig:025 width=100% height=100% }

Для самостоятельного задания создадим необходимые каталоги (рис. [-@fig:026]):

![Создание необходимых каталогов](images/26.png){ #fig:026 width=100% height=100% }

Затем напишем скрипты по примеру из прошлых лабораторных работ (рис. [-@fig:027] - рис. [-@fig:029]):

![Написание 1 скрпита](images/27.png){ #fig:027 width=100% height=100% }

![Написание 2 скрпита](images/28.png){ #fig:028 width=100% height=100% }

![Написание 3 скрпита](images/29.png){ #fig:029 width=100% height=100% }

Запустим на выполнение скрипты для первой части самостоятельного задания (рис. [-@fig:030]):

![Выполнение скриптов](images/30.png){ #fig:030 width=100% height=100% }

Изменим параметры в скрипте для первого задания и запустим на выполнение (рис. [-@fig:031] - рис. [-@fig:032]):

![Изменение параметров](images/31.png){ #fig:031 width=100% height=100% }

![Выполнение скриптов](images/32.png){ #fig:032 width=100% height=100% }

Просмотрим полученные графики (рис. [-@fig:033] - рис. [-@fig:034]):

![График №1](images/33.png){ #fig:033 width=100% height=100% }

![График №2](images/34.png){ #fig:034 width=100% height=100% }
